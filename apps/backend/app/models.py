...
class GitHubInstallation(Base):
    ...
    github_installation_id: Mapped[str] = mapped_column(String(80), unique=True, index=True)
    github_account_id: Mapped[str] = mapped_column(String(80), nullable=False)
    github_account_login: Mapped[str] = mapped_column(String(120), nullable=False)
    github_account_type: Mapped[str] = mapped_column(String(40), nullable=False)
    repository_selection: Mapped[str] = mapped_column(String(20), nullable=False, default="selected")
...
class Repository(Base):
    ...
    __table_args__=(UniqueConstraint("organization_id", "owner", "name", name="uq_repository_org_owner_name"),)
    id: Mapped[str] = mapped_column(String(36), primary_key=True, default=lambda: str(uuid4()))
    organization_id: Mapped[str|None] = mapped_column(ForeignKey("organizations.id"), nullable=True, index=True)
    owner: Mapped[str] = mapped_column(String(100)); name: Mapped[str] = mapped_column(String(100)); default_branch: Mapped[str] = mapped_column(String(100), default="main"); active: Mapped[bool] = mapped_column(Boolean, default=True); pr_comments_enabled: Mapped[bool] = mapped_column(Boolean, default=False); pr_comment_min_confidence: Mapped[float] = mapped_column(Float, default=0.8); pr_comment_allowed_branches: Mapped[str] = mapped_column(Text, default="main"); pr_comment_include_similar_incident: Mapped[bool] = mapped_column(Boolean, default=True); pr_comment_include_patch: Mapped[bool] = mapped_column(Boolean, default=False); github_token: Mapped[str|None] = mapped_column(Text, nullable=True, default=None); credential_source: Mapped[str] = mapped_column(String(20), nullable=False, default="PAT"); github_repository_id: Mapped[str|None] = mapped_column(String(80), nullable=True, index=True); github_installation_id: Mapped[str|None] = mapped_column(ForeignKey("github_installations.id"), nullable=True, index=True); webhook_secret: Mapped[str] = mapped_column(String(255), nullable=False, default=lambda: secrets.token_urlsafe(32)); created_at: Mapped[datetime] = mapped_column(DateTime(timezone=True), default=now); updated_at: Mapped[datetime] = mapped_column(DateTime(timezone=True), default=now, onupdate=now)
...
class WorkflowRun(Base):
    ...
    __table_args__=(UniqueConstraint("repository_id", "github_run_id", "run_attempt", name="uq_workflow_run_github_attempt"),)
    id: Mapped[str] = mapped_column(String(36), primary_key=True, default=lambda: str(uuid4()))
    organization_id: Mapped[str|None] = mapped_column(ForeignKey("organizations.id"), nullable=True, index=True)
    ...
    run_attempt: Mapped[int|None] = mapped_column(nullable=True, index=True)
...
class FailureAnalysis(Base):
    ...
    id: Mapped[str] = mapped_column(String(36), primary_key=True, default=lambda: str(uuid4()))
    organization_id: Mapped[str|None] = mapped_column(ForeignKey("organizations.id"), nullable=True, index=True)
    repository_id: Mapped[str|None] = mapped_column(ForeignKey("repositories.id"), nullable=True); workflow_run_id: Mapped[str|None] = mapped_column(String(80), nullable=True, index=True); run_attempt: Mapped[int|None] = mapped_column(nullable=True, index=True); workflow_name: Mapped[str] = mapped_column(String(200), default="Manual analysis"); branch: Mapped[str] = mapped_column(String(200), default="main"); commit_sha: Mapped[str] = mapped_column(String(100), default=""); source: Mapped[str] = mapped_column(String(20), default="DEMO"); category: Mapped[str] = mapped_column(String(50)); summary: Mapped[str] = mapped_column(String(500)); root_cause: Mapped[str] = mapped_column(Text); failed_step: Mapped[str] = mapped_column(String(200), default="Unknown"); confidence: Mapped[float] = mapped_column(Float); severity: Mapped[str] = mapped_column(String(20)); cleaned_log: Mapped[str] = mapped_column(Text); raw_log_excerpt: Mapped[str] = mapped_column(Text); suggested_actions: Mapped[str] = mapped_column(Text, default="[]"); fingerprint: Mapped[str] = mapped_column(String(128), default="", index=True); occurrence_count: Mapped[int] = mapped_column(default=1, index=True); first_seen: Mapped[datetime|None] = mapped_column(DateTime(timezone=True), nullable=True, index=True); last_seen: Mapped[datetime|None] = mapped_column(DateTime(timezone=True), nullable=True, index=True); resolved: Mapped[bool] = mapped_column(Boolean, default=False); status: Mapped[str] = mapped_column(String(20), default="OPEN", index=True); resolved_at: Mapped[datetime|None] = mapped_column(DateTime(timezone=True), nullable=True, index=True); resolved_by: Mapped[str|None] = mapped_column(String(36), nullable=True, index=True); resolution_note: Mapped[str|None] = mapped_column(Text, nullable=True); analysis_time_minutes: Mapped[float] = mapped_column(Float, default=0.0); resolution_time_minutes: Mapped[float] = mapped_column(Float, default=0.0); actual_solution: Mapped[str|None] = mapped_column(Text, nullable=True); created_at: Mapped[datetime] = mapped_column(DateTime(timezone=True), default=now); updated_at: Mapped[datetime] = mapped_column(DateTime(timezone=True), default=now, onupdate=now)
    failed_command: Mapped[str|None] = mapped_column(String(500), nullable=True)
...
class User(Base):
    ...
    github_user_id: Mapped[str|None] = mapped_column(String(80), nullable=True, unique=True, index=True)
